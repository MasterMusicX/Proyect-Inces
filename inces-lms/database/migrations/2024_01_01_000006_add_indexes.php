...
return new class extends Migration {
    public function up(): void {
        // Full-text search index on document_analysis
        DB::statement("
        ...
        ");
        DB::statement("CREATE INDEX IF NOT EXISTS idx_doc_analysis_search ON document_analysis USING gin(search_vector)");
