...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ── Modules ──────────────────────────────────────────
        $modules1 = [
            ['title' => 'Unidad 1: Introducción a la Administración', 'order' => 1],
            ['title' => 'Unidad 2: Planificación Estratégica',        'order' => 2],
            ['title' => 'Unidad 3: Organización Empresarial',         'order' => 3],
            ['title' => 'Unidad 4: Control y Evaluación',             'order' => 4],
        ];
        foreach ($modules1 as $m) {
            Module::firstOrCreate(
                ['course_id' => $course1->id, 'title' => $m['title']],
                array_merge($m, ['is_published' => true])
            );
        }

        $modules2 = [
            ['title' => 'Módulo 1: Hardware y Software',      'order' => 1],
            ['title' => 'Módulo 2: Sistema Operativo Windows','order' => 2],
            ['title' => 'Módulo 3: Microsoft Office',         'order' => 3],
            ['title' => 'Módulo 4: Internet y Seguridad',     'order' => 4],
        ];
        ...
        $faqs = [
            [
                ...
                'tags'     => ['inscripción', 'curso', 'registro'],
            ],
            [
                'category' => 'faq',
            ...
            [
                ...
                'tags'     => ['contraseña', 'acceso', 'recuperar'],
            ],
            [
                'category' => 'faq',
                ...
                'tags'     => ['inces', 'instituto', 'información'],
            ],
            [
                'category' => 'faq',
                ...
                'tags'     => ['certificado', 'completar', 'logro'],
            ],
        ];
